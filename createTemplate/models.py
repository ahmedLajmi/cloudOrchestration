...
class Compute(models.Model):
    ...
    disk_size = models.IntegerField(verbose_name=u'Disk size')
    mem_size = models.IntegerField(verbose_name=u'Memory size')
